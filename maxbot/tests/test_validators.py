"""Unit-тесты для validators.py — чистые функции валидации ввода
(телефон, количество, артикул) — см. promt.md, раздел «Безопасность»."""
...
@pytest.mark.parametrize(
    "raw,ok",
    [("ABC123", True), ("a_b-1", True), ("", False), ("бук", False), ("x" * 33, False)],
)
