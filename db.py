...
Модели:
  ...
  Product   — товар из поста канала (name, price, post_id, photo_url)
...
Статусы заказа:
  ...
  paid      → оплачен (чек принят, ждёт проверки Романом)
...
class Product(Base):
    ...
    video_ids: Mapped[str | None] = mapped_column(Text, nullable=True)
